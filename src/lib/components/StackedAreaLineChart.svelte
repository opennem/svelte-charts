<script>
	...
	import StackedAreaLine from './elements/StackedAreaLine.svelte';
	...
	import ClipPath from './elements/ClipPath.svelte';
	import LineX from './annotations/LineX.svelte';
	import Dot from './annotations/Dot.svelte';
	import Shading from './annotations/Shading.svelte';
	...
	/** @type {import('$lib/stores/chart.svelte.js').default} */
